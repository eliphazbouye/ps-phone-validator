...
class Sm_phone_validator extends Module
{
    ...
    {
        Configuration::updateValue('SM_PHONE_VALIDATOR_LIVE_MODE', false);
    ...
    {
        Configuration::deleteByName('SM_PHONE_VALIDATOR_LIVE_MODE');
